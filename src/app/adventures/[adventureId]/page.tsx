...
export default function Adventure(props: {
	params: Promise<{ adventureId: Id<"adventures"> }>; // Updated to Promise
}) {
	...
	const entries = useQuery(api.chat.getAllEntries, {
		adventureId, // Cast to the expected type
	});
	...
	return (
		<main className="flex min-h-screen flex-col items-center justify-between p-24 font-chakra bg-black">
